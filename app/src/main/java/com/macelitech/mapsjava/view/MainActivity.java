...
import com.macelitech.mapsjava.adapter.PlaceAdapter;
import com.macelitech.mapsjava.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) { //menu connect to xml-code block
        if(item.getItemId()==R.id.addplace){
            Intent intent = new Intent(MainActivity.this,MapsActivity.class); // connect classes
